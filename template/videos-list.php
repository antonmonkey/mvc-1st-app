    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="videos-list.php"><i class="fa fa-fw fa-list-alt"></i> Videos List</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="/template/forms.html"><i class="fa fa-fw fa-edit"></i> Forms</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <?php foreach ($videosList as $videosItem):?>

                    <div class="col-md-4 portfolio-item">
                        <a href="#">
                            <img class="img-responsive" src='/template/images/<?php echo $videosItem['img_name']?>' alt="">
                        </a>
                        <h3>
                            <a href="#">Tittle: <?php echo $videosItem['name'];?></a>
                        </h3>
