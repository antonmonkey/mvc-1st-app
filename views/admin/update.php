                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Update video<small>in database</small>
                        </h1>
                    </div>
                </div>
                <!-- /.row -->
                      ...
                      <div class="col-lg-4">
                        <div class="input-group">
                          <span class="input-group-addon" id="sizing-addon1">Название видоса</span>
                            <input name="name" type="text" class="form-control" placeholder="Тайтл видоса" aria-describedby="sizing-addon1" value="<?php echo $video['name']; ?>">
                        </div>
                      </div>
                  </div>
                      ...
                      <div class="col-lg-4">
                        <div class="input-group">
                          <span class="input-group-addon" id="sizing-addon1">Катеория</span>
                            <input name="category" type="text" class="form-control" placeholder="через пробел. пример - aerial dop" aria-describedby="sizing-addon1" value="<?php echo $video['category']; ?>">
                        </div>
                      </div>
                  </div>
                  <div class="row margin-top">
